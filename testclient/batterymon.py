...
print("                                 |^--------------unused")
print("                                 ^---------------unused")
row = client.read_input_registers(5, count=1, unit=20)
row = client.read_input_registers(5, count=1, unit=unit)
print("             MCU Voltage (0005):", 0.001*toInt(row), "V")
row = client.read_input_registers(6, count=1, unit=20)
